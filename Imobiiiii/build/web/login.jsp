<%-- 
    Document   : login
    Created on : 08/12/2010, 17:01:14
...
<html>
    ...
    <html>
        ...
        <center>
            ...
            <table width="300" bgcolor="#FF6600" border="0" cellspacing="3" cellpadding="1">
                 <caption >
                     <strong>CONTROLE DE ACESSO</strong>
                    </caption>
               
                <tr>
                    <td><strong> LOGIN  </strong></td><td><input type="text" size="30" name="login"></input> </td>
                </tr>
                <tr>
                    <td><strong> SENHA </strong></td><td><input type="password" size="30" name="senha"></input></td>
                </tr>
            ...
            <p><br/>
            <input type="submit" value=" Entrar "></input>&nbsp;<input type="reset" value=" Limpar "></input>
            <INPUT TYPE="BUTTON" VALUE="Voltar" ONCLICK="history.go(-1)">
            </p>
            <a href="inserirCliente.jsp">
            <p>
                <strong>
                    Não é cadastrado? Faça aqui seu cadastro!
                    <br/>
                    É gratuito!!
                </strong>
            </p>
