<%-- 
    Document   : buscarCorretor
    Created on : 08/12/2010, 18:45:16
...
<body>
    ...
    <h4 align="center">Busca de Corretor</h4>
    <h4 align="center"> Digite Aqui o CPF do Corretor</h4>
    <p align="center">&nbsp;</p>
            <div align="center"><br />
            </div>
            <form action="consultaCorretor.jsp" method="post">
              <div align="center">
                <table width="272" height="100" border="0" cellpadding="1" cellspacing="3" class="mario">
                  <tr>
                    <td width="264"><div align="center"><strong>CPF
                      <input type="text" size="30" maxlength="14" name="cpfCorretor"  >
                    </strong></div></td>
                  </tr>
                  <tr>
