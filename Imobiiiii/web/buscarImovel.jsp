<%-- 
    Document   : buscarImovel
    Created on : 08/12/2010, 18:45:37
                    ...
                    <div id="logo">
                        ...
                        <div>
                            ...
                            <div align="center"><span>Empresa no Ramo de Aluguel de Imóveis</span><br />
                                Nossa satisfao  a sua confiança
                            </div>
                        </div>
                    </div>
                </div>
        </div>        <div id="content_right">
    <h4 align="center"> Busca de Imovel </h4>
    <h4 align="center">Digite aqui o número de Identificação do Imovel<a class="painel" href="adm.jsp"></a></h4>
            <br />
            <form action="consultaImovel.jsp" method="post">
              <div align="center">
                <table width="295" height="98" border="0" cellpadding="1" cellspacing="3" class="mario">
                  <tr>
                    <td width="269"><div align="center"><strong>ID do Imovel
                      <input type="text" size="30" maxlength="14" name="idImovel"  >
                    </strong></div></td>
                  </tr>
                  <tr>
                    <td width="269" height="22">&nbsp;</td>
                  </tr>
