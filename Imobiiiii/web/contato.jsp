<%-- 
    Document   : contato
    Created on : 13/12/2010, 18:36:24
            ...
            <div id="main">
              ...
              <!-- content begins -->
                <div id="content">
                  ...
                  <h2 id="main">Contato</h2>
                  <p>Escola Técnica Estadual - ETE</p>
                  <p>Curso Técnico em Informática - Turma B</p>
                  
                  <p>Mario Antonio da Silva Filho</p>
                  <p>Nigel Mendes</p>
                  <p>Arnaldo severino de Freitas</p>
                  </div>
              </div>
                <!-- content ends -->
                <!-- footer begins -->
